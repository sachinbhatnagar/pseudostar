...
Tests run the bundled production Worker in Miniflare with real local D1. Only outbound Resend HTTP is intercepted. They need local loopback access. No test sends email or deploys. The migration is tested on fresh and populated local D1 databases.
